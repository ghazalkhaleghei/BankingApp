...
public class Server extends Thread {
     ...
     */
     ...
     public void run() {
 		...
 		System.out.println("\n Terminating server " +this.serverThreadId+ " - Running time " + (serverEndTime - serverStartTime)
 				+ " milliseconds");
 		
 		setServerThreadRunningStatus1("Terminated");
 		
 		}
 		else if(this.serverThreadId.equals("Thread2"))
 		{
 	 		serverStartTime = System.currentTimeMillis();
 	 		processTransactions(trans);
 	 		serverEndTime = System.currentTimeMillis();
 		...
 		else if(this.serverThreadId.equals("Thread3"))
 		{
 	 		serverStartTime = System.currentTimeMillis();
 	 		processTransactions(trans);
 	 		serverEndTime = System.currentTimeMillis();
 		...
 		if(getServerThreadRunningStatus1().equals("Terminated")
 		 ...
 		 &&getServerThreadRunningStatus3().equals("Terminated")) {
 			
 		Network.disconnect(Network.getServerIP());
 		
 		System.out.println("\n Terminating the main server");
